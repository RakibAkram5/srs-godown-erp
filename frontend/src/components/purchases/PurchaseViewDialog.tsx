          ...
          <>
            <div ref={invoiceRef} className="rounded-lg border border-border bg-background p-5">
              ...
              <div className="mt-4 ml-auto max-w-xs space-y-1 text-sm">
                ...
                <div className="flex justify-between border-t border-border pt-1 text-base font-bold"><span>Total</span><span>{formatCurrency(purchase.totalAmount, currency)}</span></div>
              </div>
            ...
            <DialogFooter className="no-print flex-wrap">
              ...
              <Button variant="outline" onClick={() => purchaseInvoicePdf(purchase, { companyName, currency })}>
